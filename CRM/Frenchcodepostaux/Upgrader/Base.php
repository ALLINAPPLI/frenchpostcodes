 ...
 */
class CRM_Frenchcodepostaux_Upgrader_Base {

  /**
   * @var CRM_Frenchcodepostaux_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Frenchcodepostaux_Upgrader(
        'frenchcodepostaux',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Frenchcodepostaux_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Frenchcodepostaux_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
